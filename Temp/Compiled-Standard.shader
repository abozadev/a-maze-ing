// Compiled shader for PC, Mac & Linux Standalone, uncompressed size: 759.6KB
...
SubShader { 
 ...
 //       d3d11 : 144 avg math (143..145), 2 avg texture (2..3), 4 branch
 //        d3d9 : 166 avg math (166..167), 6 avg texture (6..7), 5 branch
 Pass {
  Name "FORWARD"
...
//
    ...
    def c23, 0.785398185, 9.99999975e-05, 0.00999999978, 0
    ...
    dp2add_pp r3.z, r3.z, r4.x, c22.w
    mad_pp r3.y, r3.z, r3.y, c20.x
    mad_pp r3.z, r3.z, r2.x, c20.x
    mul_pp r3.y, r3.z, r3.y
    mul r2.z, r2.z, r3.x
    mul_pp r3.x, r2.z, c23.x
    mad r2.z, r2.z, -c23.x, c23.y
    rsq r3.z, r3.x
    rcp_pp r3.z, r3.z
    cmp_pp r2.z, r2.z, c23.z, r3.z
...
"
 ...
 // Stats for Fragment shader:
 //       d3d11 : 82 avg math (73..94), 3 avg texture (1..7)
...
//
    ...
    def c7, 0, 3.14159274, -0.5, 0.785398185
...
//
  ...
  52: dp2 r0.y, r0.yyyy, r0.yyyy
  53: mad r0.y, r0.y, r0.w, l(-0.500000)
  54: mul r0.w, r0.z, r0.z
  55: mul r0.w, r0.w, r0.w
  56: mul r0.z, r0.z, r0.w
  57: sample r2.xyzw, v1.xyxx, t0.xyzw, s0
  58: mad r3.xyz, cb0[8].xyzx, r2.xyzx, -cb0[2].xyzx
  59: mul r2.xyz, r2.xyzx, cb0[8].xyzx
  60: mad r3.xyz, cb0[12].zzzz, r3.xyzx, cb0[2].xyzx
  61: add r4.xyz, -r3.xyzx, l(1.000000, 1.000000, 1.000000, 0.000000)
  62: mad r3.xyz, r4.xyzx, r0.zzzz, r3.xyzx
  63: mul r1.yzw, r1.yyzw, r3.xxyz
  ...
  76: mad r0.w, -cb0[12].z, cb0[2].w, cb0[2].w
...
//
    ...
    def c7, 31.622776, 9.99999975e-06, 3.14159274, 0.785398185
    def c8, 0.785398185, 9.99999975e-05, 0.00999999978, 0
    dcl_texcoord v0.xy
    dcl_texcoord1_pp v1.xyz
    dcl_texcoord2_pp v2.w
...
//
    ...
    def c8, 31.622776, 9.99999975e-06, 3.14159274, 0.785398185
...
//
    ...
    def c9, 9.99999975e-06, 0, 3.14159274, -0.5
    def c10, 0.785398185, 9.99999975e-05, 0.00999999978, 0
    dcl_texcoord v0.xy
    dcl_texcoord1_pp v1.xyz
    dcl_texcoord2_pp v2.w
    dcl_texcoord3_pp v3.w
    ...
    add_pp r0.w, r0.w, r0.w
    mul r0.y, r0.y, r0.w
    mad r0.w, r0.y, -c10.x, c10.y
    mul_pp r0.y, r0.y, c10.x
    rsq r1.w, r0.y
    rcp_pp r1.w, r1.w
    cmp_pp r0.w, r0.w, c10.z, r1.w
    abs r1.w, c3.w
...
//
    ...
    def c12, 0.00100000005, 31.622776, 9.99999975e-06, 3.14159274
    def c13, 0.785398185, 9.99999975e-05, 0.00999999978, 0
    dcl_texcoord v0.xy
    dcl_texcoord1_pp v1.xyz
    dcl_texcoord2_pp v2.w
    dcl_texcoord3_pp v3.w
    ...
    mul r1.y, r1.y, r1.z
    mad r1.z, r1.y, -c13.x, c13.y
    mul_pp r1.y, r1.y, c13.x
    rsq r2.x, r1.y
    rcp_pp r2.x, r2.x
    cmp_pp r1.z, r1.z, c13.z, r2.x
    abs r2.x, c6.w
...
//
    ...
    def c10, 0, 3.14159274, -0.5, 0.785398185
    ...
    mul_pp r1.x, r1.x, r1.x
    dp2add_pp r1.x, r1.x, r1.y, c10.z
    mul_pp r1.y, r0.w, r0.w
    mul_pp r1.y, r1.y, r1.y
